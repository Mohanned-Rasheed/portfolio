...
function Skills() {
  return (
    <div id="Skills" className="my-14 md:flex">
      <motion.h2
        initial={{ y: -70, opacity: 0 }}
        whileInView={{ y: 0, opacity: 100 }}
        transition={{ duration: 2 }}
        viewport={{ once: true }}
        className="my-14 md:text-[3vw] text-[5vw] w-fit border-t-2 border-green-200 pt-4 xl:ml-28 md:ml-10 ml-8 font-bold"
      >
        Skills
      </motion.h2>

      <div className="mt-10 xl:mx-28 md:mx-7 mx-2 grid 2xl:grid-cols-5 xl:grid-cols-4 md:grid-cols-4 sm:grid-cols-3 grid-cols-3 gap-5">
        <AtomOfSkill
          img={ReactImg}
          initial={0}
          animate={10}
